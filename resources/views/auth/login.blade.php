...
<head>
    ...
    <style>
        ...
        .swal2-confirm:hover { transform: translateY(-1px) !important; box-shadow: 0 6px 8px -1px rgba(15, 118, 110, 0.3) !important; }
    </style>
</head>
<body class="login-page" x-data="{
    activeTab: '{{ ($errors->has('nik_ortu') || $errors->has('nama_lengkap') || $errors->has('nomor_kontak') || $errors->has('reg_username') || $errors->has('reg_password')) ? "register" : (session("error") || $errors->has("username") || $errors->has("password") ? "login" : (request("tab") === "register" ? "register" : "login")) }}',
    showPassword: false,
    ...
    <div class="login-wrapper">
        ...
        <div class="login-form-panel">
            ...
            <div x-show="activeTab === 'register'" x-transition:enter="tab-enter" x-transition:leave="tab-leave" style="display: none;">
                <div class="login-form-header" style="margin-bottom: 1.5rem; text-align: left;">
                    <h2 class="login-form-title">Daftar Akun</h2>
                    <p class="login-form-subtitle">Daftarkan akun untuk mengakses layanan Ibu Hamil, Keluarga Berencana, dan Tumbuh Kembang Anak.</p>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @elseif ($errors->has('username'))
                Swal.fire({
                    icon: 'error',
                    title: 'Login Gagal',
                    text: '{!! addslashes($errors->first('username')) !!}',
                    confirmButtonColor: '#0f766e',
                    confirmButtonText: 'Tutup'
                });
            @endif
