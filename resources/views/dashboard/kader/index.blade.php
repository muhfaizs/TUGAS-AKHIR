...
@section('content')
    ...
    <div class="dash-grid" id="summary-cards">
        ...
        <div class="dash-card" style="border-top: 4px solid #0EA5E9; background: #fff;" id="card-kb-akseptor">
            <div class="dash-card-header">
                <div class="dash-card-icon" style="background: #E0F2FE; color: #0EA5E9;">
                    <svg viewBox="0 0 24 24" style="fill: currentColor; width: 24px; height: 24px;"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                </div>
            </div>
            <div class="dash-card-value">{{ $totalAkseptor }}</div>
            <div class="dash-card-label">Total Akseptor KB</div>
        </div>
    </div>
