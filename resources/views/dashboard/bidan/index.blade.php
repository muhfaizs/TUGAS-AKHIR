                                ...
                                <td style="padding: 16px 24px; vertical-align: middle; border-bottom: 1px solid rgba(15,23,42,0.04);">
                                    <div style="display: flex; gap: 8px;">
                                        ...
                                        @if($anak->orangTua && $anak->orangTua->nomor_kontak)
                                            <!-- Panggilan Sistem -->
                                            <form action="{{ route('bidan.anak.send-system', $anak->id_anak) }}" method="POST" style="display:inline;">
                                                @csrf
                                            ...
                                            <!-- Kirim WA -->
                                            <form action="{{ route('bidan.anak.send-notification', $anak->id_anak) }}" method="POST" target="_blank" style="display:inline;">
                                                @csrf
