...
@section('content')
    ...
    <div class="dash-grid" id="summary-cards">
        ...
        <div class="dash-card dash-card--teal" id="card-ibu-hamil">
            <div class="dash-card-header">
                <div class="dash-card-icon dash-card-icon--teal">
            ...
            <div class="dash-card-value">{{ \App\Models\User::where('role', 'ibu_hamil')->count() }}</div>
            <div class="dash-card-label">Ibu Hamil Terdaftar</div>
        </div>

        <div class="dash-card dash-card--amber" id="card-pasien-kb">
            <div class="dash-card-header">
                <div class="dash-card-icon dash-card-icon--amber">
                    <svg viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                </div>
            </div>
            <div class="dash-card-value">{{ \App\Models\User::where('role', 'pasien_kb')->count() }}</div>
            <div class="dash-card-label">Total Pasien KB</div>
        </div>
    </div>
@endsection
