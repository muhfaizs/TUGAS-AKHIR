...
@section('content')
    <div style="margin-bottom: 24px;">
        <a href="{{ route('dinkes.dashboard') }}" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 600; color: #475569; text-decoration: none; padding: 8px 16px; background: #F1F5F9; border-radius: 8px;">
