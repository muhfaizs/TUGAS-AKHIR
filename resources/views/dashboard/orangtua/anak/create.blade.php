        ...
        <form method="POST" action="{{ route($routePrefix . '.anak.store') }}" id="form-anak">
            ...
            <div x-show="step === 3" x-transition:enter="slide-in" class="wizard-step" style="display: none;">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="tel" id="nomor_kontak_darurat" name="nomor_kontak_darurat" value="{{ old('nomor_kontak_darurat', auth()->user()->isOrangTua() ? auth()->user()->nomor_kontak : '') }}" class="form-input" placeholder="08xxxxxxxxxx">
                </div>
                <div class="form-group">
                    <label for="alamat_domisili">Alamat Domisili Bayi / Orang Tua</label>
                    <textarea id="alamat_domisili" name="alamat_domisili" class="form-input" rows="2" placeholder="Masukkan alamat lengkap domisili...">{{ old('alamat_domisili', auth()->user()->isOrangTua() ? auth()->user()->alamat_domisili : '') }}</textarea>
                </div>
                <div class="form-group mt-4">
