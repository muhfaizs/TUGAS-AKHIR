        ...
        @if(!empty($pengingatList))
            <div class="no-print" style="margin-bottom: 24px;">
                @foreach($pengingatList as $pengingat)
                    <div style="background: rgba(245, 158, 11, 0.1); border-left: 4px solid #F59E0B; padding: 16px; border-radius: 8px; display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
